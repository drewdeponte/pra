require_relative "../../../lib/clipuller/github_pull_source"

describe Clipuller::GithubPullSource do
  describe "#pull_requests" do
    ...
    it "gets the pull requests for each repository" do
      ...
      pull_source = Clipuller::GithubPullSource.new(config)
  ...
  describe "#rest_api_pull_request_resource" do
    ...
    subject { Clipuller::GithubPullSource.new(config) }
